/**
 * AI Analysis Routes - OpenRouter powered endpoints
 * Provides direct AI analysis access for the frontend
 */
...
// Middleware: all AI routes require authentication
 ...
 * AI code review for coding challenges
 */
 ...
 * Generate custom interview questions on demand
 */
router.post('/generate-questions', async (req, res) => {
  try {
    ...
    // Free plan users are only allowed to generate HR interview questions
    if (type !== 'HR') {
      const user = mockDb.users.findOne({ id: req.user.userId });
 ...
 * Generate personalized performance feedback after a session
 */
...
/**
 * GET /api/ai/status
 * Check if OpenRouter AI is available
 */
